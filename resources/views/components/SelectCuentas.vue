...
export default {
  ...
  methods: {
    async loadCategorias() {
      ...
      try {
        const response = await axios.get('/api/movimientos/cuentas')
...
/* Ajusta el padding del valor seleccionado */
.vs__selected {
  padding: 0; /* o ajusta según lo que necesites */
  margin: 0;
  line-height: 1.5;
}

/* Ajusta el tamaño de fuente si quieres */
.vs__selected, .vs__selected-item {
  font-size: 0.875rem;
}

/* También ajusta el height del dropdown toggle si hace falta */
.vs__dropdown-toggle {
